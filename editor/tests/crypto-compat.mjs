...
if (!bundledText.includes('id="commandcodex-variable-config"')) throw new Error('Bundled encrypted source is missing encrypted variable configuration');
